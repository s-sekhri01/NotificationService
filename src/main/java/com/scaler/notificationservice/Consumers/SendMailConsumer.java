...
import com.scaler.notificationservice.DTOs.SendEmailMessageDTO;
import com.scaler.notificationservice.Utils.EmailUtils;
...
public class SendMailConsumer {
    ...
    @Autowired
    public SendMailConsumer(EmailUtils emailUtil) {
    ...
    public void handleSendEmail(String message) throws JsonProcessingException {
        ...
        Authenticator auth = new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("saranshsekhri@gmail.com", "");
            }
        };
